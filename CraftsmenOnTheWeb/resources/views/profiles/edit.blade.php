    ...
    <div class="w-full my-6">
        ...
        @if (Auth::user()->profile === null)
            <div class="flex justify-between items-center">
                ...
                <a href="{{ route('profiles.profile') }}" class=" hover:warm-red">Skip for now</a>
            </div>
            ...
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8 bg-gray-100" method="POST"
                    ...
                    <div class="container md:responsive">
                        ...
                        <div class="flex flex-wrap md:mb-6">
                            <label for="alias" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4 ml-2 font-['aspergit']">
                                {{ __('Alias') }}
                            </label>
                        ...
                        <div class="flex flex-wrap md:mb-6">
                            <label for="craft" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4 ml-2 font-['aspergit']">
                        ...
                        <div class="flex flex-wrap md:mb-6">
                            <label for="motivation" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4 ml-2 font-['aspergit']">
        ...
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('profiles.profile') }}" class=" hover:warm-red">Cancel</a>
        </div>
        ...
        <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
            ...
            <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8 bg-gray-100" method="POST"
                ...
                <div class="flex flex-wrap pb-8 warm-red">
                    <button type="submit"
                    class="select-none font-bold whitespace-no-wrap p-8 rounded-lg text-base leading-normal no-underline text-gray-100 bg-warm-red sm:py-4 font-['aspergit']">
                    {{ __('Confirm') }}
                    </button>
                </div>
            </form>
