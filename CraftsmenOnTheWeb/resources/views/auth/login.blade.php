        ...
        <div class="w-full">
            ...
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <form class="w-full bg-form px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex flex-wrap">
                        <button type="submit"
                        class="select-none font-bold whitespace-no-wrap py-4 px-6 rounded-lg text-base leading-normal no-underline text-gray-100 bg-warm-red sm:py-4">
                            {{ __('Login') }}
                        </button>

                        @if (Route::has('password.request'))
                        <a class="w-full text-sm text-center hover:text-blue-700 whitespace-no-wrap no-underline hover:underline my-6 sm:text-sm sm:my-8"
                        ...
                        <p class="w-full text-sm  text-center text-gray-700 mb-6 sm:text-sm sm:mb-8">
